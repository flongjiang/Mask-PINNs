...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--epochs", type=int, default=50000, help="Number of ADAM training epochs.")
    parser.add_argument("--seeds", type=int, nargs="+", default=[42, 0, 9, 5, 1979], help="Random seeds.")
    parser.add_argument("--output-dir", type=Path, default=Path("results"), help="Directory for logs/checkpoints.")
    parser.add_argument("--device", type=str, default=None, help="Device, e.g. 'cuda', 'cpu', or 'cuda:0'.")
    parser.add_argument("--hidden-dim", type=int, default=128, help="Hidden width of the network.")
    parser.add_argument("--num-blocks", type=int, default=5, help="Number of MaskBlocks.")
    parser.add_argument("--num-boundary-points", type=int, default=100, help="Boundary points per side.")
    parser.add_argument("--num-collocation-points", type=int, default=10000, help="Interior collocation points.")
    parser.add_argument("--grid-size", type=int, default=201, help="Evaluation grid size per direction.")
    parser.add_argument("--learning-rate", type=float, default=1.0e-4, help="ADAM learning rate.")
