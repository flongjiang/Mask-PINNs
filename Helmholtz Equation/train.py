"""Train Mask-PINN for the 2D Helmholtz equation."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Mask-PINN for the 2D Helmholtz equation.")
...
def main():
    ...
    x_eval, y_eval, exact_eval = build_reference_solution()
