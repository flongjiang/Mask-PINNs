"""Train a Mask-PINN on a 1D linear advection benchmark.

Example:
    python train.py --epochs 50000 --seeds 5 0 9 42 1979 --output-dir results
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Mask-PINN for a 1D linear advection problem.")
    ...
    parser.add_argument("--num-initial-points", type=int, default=200)
    parser.add_argument("--num-boundary-points", type=int, default=200)
    parser.add_argument("--num-collocation-points", type=int, default=5000)
...
def main() -> None:
    ...
    x_eval, t_eval, exact_eval = build_reference_solution(config)
